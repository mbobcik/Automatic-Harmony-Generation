...
\subsection*{Neurony}
Základem neuronových sítí jsou neurony,
...
Další aktivační funkcí je tzv. \emph{Rectified Linear Unit} (dále jen ReLU).
...
kde se stará o to, aby suma výstupních hodnot neuronů rovnala jedné.
...
Kde $j \epsilon (1,N)$ a N je délka výstupního vektoru.
...
která bude naučená sít zpracovávat.
...
Tato funkce se často používá zároveň s aktivační funckí softmax,
...
ale mohou uváznout v lokálním minimu, z nějž už se nebudou moci dostat.
...
\begin{figure*}[h]\centering
    \centering
    \includegraphics[width=0.6\linewidth]{obrazky/GradientDescent.png}\\[1pt]  
...
Principem RNN jsou smyčky, kdy výstupy jedné vrstvy jsou
...
\begin{figure*}[h]\centering
    \centering
    \includegraphics[width=0.6\linewidth]{obrazky/LSTM3-chain.png}\\[1pt]  
...
Každá buňka může informaci přidat, nebo odebrat.
Je také možné stav nechat beze změny.\cite{colah_lstm}
\par

Při práci musí LSTM nejprve rozhodnout,
...
\begin{figure*}[h]\centering
    \centering
    \includegraphics[width=0.6\linewidth]{obrazky/LSTM3-focus-f.png}\\[1pt]  
...
opět vrstva se sigmoidou jako aktivační funkcí.
...
\begin{figure*}[h]\centering
    \centering
    \includegraphics[width=0.6\linewidth]{obrazky/LSTM3-focus-i.png}\\[1pt]  
...
\begin{figure*}[h]\centering
    \centering
    \includegraphics[width=0.6\linewidth]{obrazky/LSTM3-focus-C.png}\\[1pt]  
...
Dá se řící, že tento krok je podobný obrácení předchozího kroku.
...
\begin{figure*}[h]\centering
    \centering
    \includegraphics[width=0.6\linewidth]{obrazky/LSTM3-focus-o.png}\\[1pt]  
...
\begin{figure*}[h]\centering
    \centering
    \includegraphics[width=0.6\linewidth]{obrazky/LSTM3-var-peepholes.png}\\[1pt]  
...
ze korpusu do vektorů reálných čísel.
...
\end{itemize}
Jak bylo řečeno v~kapitole \ref{trenovaniModelu},
...
Z důvodu širokého spektra záměrů v oblasti generování hudby,
...
s původní akordy z anotované skladby,
...
Pro vyhodnocení poslechem je, mimo jiné, možné využít 
...
Cílem je zjistit, jestli model špatně zvládá harmonizovat jenom krátké skladby, 
