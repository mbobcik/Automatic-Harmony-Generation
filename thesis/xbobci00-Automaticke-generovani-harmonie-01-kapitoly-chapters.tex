...
a jak s jeho pomocí harmonizovat melodii.
Dále jsou představeny experimenty na tomto modelu provedené.
Model jako takový je popsán v kapitolách \ref{magenta} a \ref{navrhSystemu},
postup jeho zprovoznění a trénování pak v kapitole \ref{trenovaniModelu}.
...
\begin{verbatim}
polyphony_rnn_generate \
    --bundle_file=./mnt/d/tmp/polyphony_rnn.mag \
