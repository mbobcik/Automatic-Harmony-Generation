...
Ty ale byly málo kdy zaveden do skladby v pravý čas, 
...
Z toho lze usoudit, že pri použití většího modelu by mohlo přinést výsledky lepší.
...
Tato práce by vyžadovala použití datové sady, 
