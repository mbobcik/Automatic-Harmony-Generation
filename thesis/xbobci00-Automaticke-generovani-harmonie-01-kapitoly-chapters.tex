...
Hlavička určuje pozici noty, a může být buď vyplněná ( \halfNote ), nebo nevyplněná ( \quarterNote ). 
Nožka opět buď může být, a nebo nemusí ( \wholeNote ). 
Pokud nota nožku má, pak ji, u not na třetí, prostřední lince a vyšších, píšeme směrem dolů ( \halfNoteDown ),
a naopak u nižších not směrem nahoru.
I toto pravidlo má ovšem nějaké vyjímky.
Poslední částí noty je praporec, těch může mít nota nula až čtyři ( \eighthNote \sixteenthNote \dots ).
Pokud je za sebou víc not s praporci, lze je spojit, a praporce nahradit trámci ( \twoBeamedQuavers )
...
\begin{itemize}
    ...
    \item \sixtyfourthNote \sixtyfourthNoteDown čtyřiašedesátinová
\end{itemize}

Podle názvů not je zřejmé, že nota celá má délku dvou půlových not, čtyř čtvrtinových osmi osminových a tak dále.
Nejbližší nižší nota má délku poloviční a nejbližší vyšší dvojnásobnou.\paragraph
