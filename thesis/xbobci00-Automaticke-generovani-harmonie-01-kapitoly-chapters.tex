...
Tónika se určuje sluchem pomocí tonálnícho cítění.
...
a posluchač necítí potřebu dalšího pokračování.\cite{zenkl}
\par
...
sequencerů, počítačů, mixérů, a dokonce i jevištní techniky, jako jsou reflektory a lasery.
\cite{MIDI_tutorials}
\par

Standartní MIDI soubor (zkráceně SFM) je formát binárních souborů 
...
Každý z těchto bloků začíná čtyřbajtovým textovým označením a čtyřbajtovou délkou bloku.
Ihned po délce začíná datová část bloku o počtu bajtů zadaném v hlavičce.
