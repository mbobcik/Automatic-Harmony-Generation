...
V dávných dobách byla hudba pouze monofoní, což znamená, 
...
\par
Cílem práce je seznámit se s problematikou automatické harmonizace na základě znalosti metodie,
...
\label{TODO-Smazat tuto vetu}
Následují cíle celé diplomové práce.

Poté implementovat daný systém s pomocí chodného frameworku pro neuronové sítě.
Implementovaný systém je potřeba otestovat na vhodné datové sadě. 
Datová sada bude obsahovat přepis rozličných písniček ze serveru \url{www.hooktheory.com}
do formátu MIDI.
...
které odhadují nejpravděpodobnjší posloupnost akordů k dané melodii.
Některé z těchto přístupů slouži jako inspirace této práce.
\par
Následuje teoretická rešerše strojového učení,
tedy disciplíny na níž stojí správnost automatizace.
Nejprvě je představeno strojové učení jako takové,
...
\label{TODO-DOPSAT podle diplomky}
...
které jsou následně použity jako vstup.\cite{Nicholson_NeuralNets}
\par
...
\subsection*{Neurony}
Mnohem obvykleji jsou vrstvy reprezentovány uzly, které nazýváme neurony.
...
\label{TODO - Dopsat jak princip uceni NN}
...
Rekurentní sítě umožňují mít takovou sekvenci jako vstup i jako výstup.\cite{Karpathy_RNNs}.
