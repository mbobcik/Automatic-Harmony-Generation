...
Data k projektu byla získána ve formě SQLite\footnotetext{\url{https://sqlite.org/index.html}} databáze.
...
Pokud je na webu písnička dohledatelná například pod odkazem \emph{https://www.hooktheory.com/theorytab/view/the-beatles/hey-jude},
...
Její jméno je \emph{id2parts} a mapuje id částí na id jejich písniček.
...
\begin{itemize}
    ...
    \item xml - BLOB\footnotetext{Binary Large Object} obsahující XML soubor s dalšími informacemi
...
počet dob v taktu, počet dob za minutu (BPM), opět tónina, mód části,
