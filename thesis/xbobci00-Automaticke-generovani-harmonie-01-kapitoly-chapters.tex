...
\subsection{Hlavička}
Blokem hlavičky začíná každý MIDI soubor a obsahuje jeho kladní popis.
Je uvozen typem bloku, čtyřmi ASCII znaky \"MThd\" 
a 32bitovou reprezentací čísla 6 (délka bloku). 
Začátek SMF je tedy pevně daný, 
a lze jej na první pohled rozeznat začínající sekvencí \emph{0x4D 54 68 64 00 00 00 06}. 
