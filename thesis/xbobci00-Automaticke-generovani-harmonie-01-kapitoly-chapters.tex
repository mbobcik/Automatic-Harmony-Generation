...
Ovšem ani po uplynutí dvaceti hodin od začátku trénování s těmito hodnotami
...
Dále si je patrné, že model používá spíše nestandardní, exotické harmonie,
...
%experiment s dlouho skladbou

%experiment s condition on primer => generování nové hudby

% pro prohlížení midi souborů použit program ... na začátek experimentů
