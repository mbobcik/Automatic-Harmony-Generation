...
Pokud signál projde, pak o neuronu lze říct, že byl aktivován.
\cite{Nicholson_NeuralNets}
...
\begin{figure*}[h]\centering
    \centering
    \includegraphics[width=0.8\linewidth]{obrazky/AccuracyEpoch.png}\\[1pt]  
    \includegraphics[width=0.8\linewidth]{obrazky/LossEpoch.png}\\[1pt]  
...
Na obrázku \ref{} lze vidět ztráta a přesnost modelu v průběhu učení.
...
jenž neví, který z akordů s melodii aktuálně souzní.
...
Harmonizace v tomto experimetu trpí podobnými neduhy, jako v tom předchozím.
...
Na tomto výtvoru se je jak povedená část (vyznačená červeně),
tak dva stejné, nepřiměřeně dlouhé akordy (vyznačené modře).
Je také vidět, že poslední modrá část už není akord, ale samotný tón.
...
Ty ale byly málo kdy zavedeny do skladby v pravý čas, 
...
výsledný působil především nudně a nezajímavě.
...
\par
Tyto skutečnosti naznačují, že ikdyž je model pro použití v harmonizaci malý,
...
trénování takového modelu je podmíňeno použitím větší výpočetní síly,
...
jimž se věnuje kapitola následující.
...
a většinou s původní melodií nezněli a kazily její dojem.
Avšak mezi vygenerovanými skladbami se našly světlé výjímky,
