...
je odproštění od chronologického postupu od začátku skladby ke konci.
...
kde jedna z dimenzí vymezuje čtyřhlas, další číslo MIDI noty a poslední čas
\footnote{V literatuře se pole s dimenzemi (MIDI nota, čas) nazývají pianoroll}.
...
Narozdíl od modelu Melody RNN, který také využívá jazykových modelů, 
Polyphony RNN dokáže pracovat s více souběžnýmí notami.
...
Skladba se rozdělena na stejné časové úseky (stepy), 
