...
zatímco místo zápoprných hodnot propaguje nulu.
...
která místo nuly při záporném vstupu propaguje zápornout hodnotu blízkou nule.
...
Po dokončení účení je síť připravena k použití.
To už zoravidla nepředstavuje takovou výpočetní zátěž,
...
Neuronové sítě si ale s formátem takových soubory neumí moc poradit,
